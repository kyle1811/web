...
; (function ($, h, i, j) {
    ...
    function EasyTicker(f, g) {
        ...
        s.elem = $(f); s.targ = $(f).children(':first-child');
        s.timer = 0; s.mHover = 0;
        s.winFocus = 1;
        ...
        function visHeight(a) {
            ...
            } else { s.elem.css('height', b) }
        }

        function adjHeight() {
            if (s.opts.height == 'auto' && s.opts.visible != 0) {
                anim = arguments.callee.caller.name == 'init' ? 0 : 1; visHeight(anim)
