    ...
    function html5Upload() {	
        ...
        sUploadURL = '/FileUpload/SE2ImageUpload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : "/FileUpload/SE2ImageUpload",	//샘플 URL입니다.
            sCallback: "/Contents/smarteditor2-master/dist/photo_uploader/popup/callback.html",	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
